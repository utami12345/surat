        ...
        <div class="card">
          <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
              <h5 class="m-0">Data Surat Masuk</h5>
              <div class="d-flex">
                <form action="<?php echo site_url('suratm/suratm_search'); ?>" method="POST" class="form-inline">
                ...
                <a href="<?php echo site_url('surat/suratm_tambah'); ?>" class="btn btn-add">Tambah Surat Baru</a>
              </div>
            </div>
          </div>
                ...
                <?php if (!empty($suratm)): ?>
                  <?php foreach ($suratm as $sm): ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('uploads/'.$sm->file_surat); ?>" class="btn btn-info btn-sm"><i class="fas fa-download"></i></a>
                      </td>
                      <td>
                        <div class="button-container">
                          <a href="<?php echo base_url('surat/suratm_edit/'.$sm->id_surat); ?>" class="btn btn-edit btn-sm"><i class="fas fa-edit"></i></a>
                          <a href="<?php echo base_url('surat/delete_surat/'.$sm->id_surat); ?>" class="btn btn-hapus btn-sm"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
