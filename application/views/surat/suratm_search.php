...
<head>
  ...
  <title>Cari Data Surat Masuk</title>
  ...
  .main-sidebar {
    background-color: #4f4f9d !important;
    }
  .btn-primary {
    background-color: #4f4f9d; 
    border-color: #4f4f9d;
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Cari Data Surat Masuk</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <form action="<?php echo site_url('suratm/suratm_search'); ?>" method="post" class="form-inline"></form>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                <?php if (!empty($suratm)): ?>
                  <?php foreach ($suratm as $sm): ?>
                    <tr>
                      <td><?php echo $sm->nomor_surat; ?></td>
                      <td><?php echo $sm->tanggal_surat; ?></td>
                      <td><?php echo $sm->asal_surat; ?></td>
                      <td><?php echo $sm->jenis_surat; ?></td>
                      <td><?php echo $sm->perihal_surat; ?></td>
                      <td>
                        <a href="<?php echo base_url('uploads/'.$sm->file_surat); ?>" class="btn btn-link"><i class="fas fa-download"></i></a>
                      </td>
                      <td>
                        <div class="button-container text-center">
                          <a href="<?php echo base_url('surat/suratm_edit/'.$sm->id_surat); ?>" class="btn btn-edit"><i class="fas fa-edit"></i></a>
                          <a href="<?php echo base_url('surat/delete_surat/'.$sm->id_surat); ?>" class="btn btn-delete"><i class="fas fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                  <?php endforeach; ?>
            ...
            <div class="text-left">
              <a href="<?php echo site_url('surat/suratm_index'); ?>" class="btn btn-back">Kembali</a>
            </div>
          </div>
        </div>
      </div>
